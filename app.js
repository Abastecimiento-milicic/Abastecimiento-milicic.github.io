...
function toNumber(v) {
  ...
  // soporte miles/decimales estilo AR: 1.234,56
...
function buildMesSelect(rows) {
  ...
  // mantener selección si existe; si no, elegir el último mes
...
/* ============================
   GRÁFICO 1: 100% apilado (AT/FT/NO)
============================ */
...
/* ============================
   GRÁFICO 2: Tendencia (líneas rectas + etiquetas %)
============================ */
