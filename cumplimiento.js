  ...
  chartMes = new Chart(canvas.getContext("2d"), {
    ...
    data: {
      ...
      datasets: [
        ...
        { type: "line", label: "Promedio dias de demora", data: avgD, yAxisID: "y1", borderColor: COLORS.blue, backgroundColor: COLORS.blue, pointRadius: 4, pointHoverRadius: 6, borderWidth: 3, tension: 0.25, fill: false, spanGaps: true, order: 99, datalabels: { display: false } },
      ]
    },
    options: {
      responsive: true,
      ...
      scales: {
        ...
        y1: {
          ...
          title: { display: true, text: "Dias de demora", color: COLORS.muted },
          ticks: { color: COLORS.muted, precision: 0, callback: (v) => v }
        }
      },
      plugins: {
