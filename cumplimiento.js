/* ============================
   CONFIG
============================ */
const CSV_CANDIDATES = ["CUMPLIMIENTO_2025.csv","CUMPLIMIENTO.csv","cumplimiento.csv","CUMPLIMIENTO 2025.csv"]; // prueba en orden
const DELIM = ";";
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  fetchFirstOk()
    .then(({ name, text }) => {
      // CSV encontrado
      setHTML("msg", "");
      const used = document.querySelector(".footnote b");
      if (used) used.textContent = name;
      ...
      CLIENT_COL = findHeaderByCandidates(CLIENT_CANDIDATES);
if (!CLIENT_COL) {
      ...
      CLASIF2_COL = findHeaderByCandidates(CLASIF2_CANDIDATES);
