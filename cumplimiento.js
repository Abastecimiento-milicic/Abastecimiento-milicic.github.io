  ...
  chartMes = new Chart(canvas.getContext("2d"), {
    ...
    data: {
      ...
      datasets: [
        ...
        { type: "line", label: "Promedio días de demora", data: avgD, yAxisID: "y1", borderColor: COLORS.blue, backgroundColor: COLORS.blue, pointRadius: 3, borderWidth: 2, tension: 0.3, order: 99 },
      ]
    },
    options: {
      responsive: true,
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  fetch(csvUrl)
    ...
    .then(text => {
      ...
      // detectar columna de días de demora si existe
      DEMORA_COL = headers.includes(DEMORA_COL) ? DEMORA_COL : null;
