...
/* ===== Heatmap por fila (por mes) ===== */
function mixColorWhiteToOrange(t){
...
function applyHeatmapPorFila(){
  ...
  trs.forEach(tr => {
    ...
    cells.forEach((td, i) => {
      ...
      td.style.setProperty('background-color', mixColorWhiteToOrange(t), 'important');
      td.style.fontWeight = t > 0.85 ? "800" : "600";
      td.style.setProperty('color', t > 0.65 ? '#0b1220' : '#0b1220', 'important');
      });
  });
}
