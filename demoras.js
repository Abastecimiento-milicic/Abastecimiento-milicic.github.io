(function() {
  ...
  window.getAreaConfig = function(areaName) {
    ...
    if (areaName === "COMPRAS" || areaName === "COMPRAS EQUIPOS" || areaName === "COMPRAS AGV") {
      ...
      extraHeaders = [
        "F. APROB. SOLPED", "F. EMISION OC", "TOTAL COLOC. OC", "DEMORA COLOC. OC", 
      ...
      extraFields = [
        ...
        r => r["dCOLOCACION OC"] !== undefined ? r["dCOLOCACION OC"] : r["COLOCACION OC"],
        r => {
          ...
          const valOCParsed = valOC && !isNaN(valOC) ? parseFloat(valOC.toString().replace(",", ".")) : null;
          if (valOCParsed !== null) {
        ...
        r => r["dTIEMPOS DE APROBACION OC"] !== undefined ? r["dTIEMPOS DE APROBACION OC"] : r["TIEMPOS DE APROBACION OC"],
        r => {
      ...
      extraColors = [
        {bg: "#e0f2fe", text: "#0369a1", cell: "rgba(224, 242, 254, 0.4)", hex: "FFE0F2FE", cellHex: "FFF0F9FF"}, {bg: "#e0f2fe", text: "#0369a1", cell: "rgba(224, 242, 254, 0.4)", hex: "FFE0F2FE", cellHex: "FFF0F9FF"}, {bg: "#e0f2fe", text: "#0369a1", cell: "rgba(224, 242, 254, 0.4)", hex: "FFE0F2FE", cellHex: "FFF0F9FF"}, {bg: "#e0f2fe", text: "#0369a1", cell: "rgba(224, 242, 254, 0.4)", hex: "FFE0F2FE", cellHex: "FFF0F9FF"},
        {bg: "#dcfce3", text: "#166534", cell: "rgba(220, 252, 227, 0.4)", hex: "FFDCFCE3", cellHex: "FFF0FDF4"}, {bg: "#dcfce3", text: "#166534", cell: "rgba(220, 252, 227, 0.4)", hex: "FFDCFCE3", cellHex: "FFF0FDF4"}, {bg: "#dcfce3", text: "#166534", cell: "rgba(220, 252, 227, 0.4)", hex: "FFDCFCE3", cellHex: "FFF0FDF4"},
        {bg: "#ffedd5", text: "#9a3412", cell: "rgba(255, 237, 213, 0.4)", hex: "FFFFEDD5", cellHex: "FFFFF7ED"}, {bg: "#ffedd5", text: "#9a3412", cell: "rgba(255, 237, 213, 0.4)", hex: "FFFFEDD5", cellHex: "FFFFF7ED"}, {bg: "#ffedd5", text: "#9a3412", cell: "rgba(255, 237, 213, 0.4)", hex: "FFFFEDD5", cellHex: "FFFFF7ED"}, {bg: "#ffedd5", text: "#9a3412", cell: "rgba(255, 237, 213, 0.4)", hex: "FFFFEDD5", cellHex: "FFFFF7ED"}
      ];
      ...
      extraFields = [
        ...
        r => r["dTIEMPO DE APROBACION SOLPED"] !== undefined ? r["dTIEMPO DE APROBACION SOLPED"] : r["TIEMPO DE APROBACION SOLPED"], 
      ...
      extraFields = [
        ...
        r => {
          ...
          const dAlm = r["dALMACEN"] && !isNaN(r["dALMACEN"]) ? parseFloat(r["dALMACEN"].toString().replace(",", ".")) : null;
          ...
          if (dAlm !== null && dAlm > 4 && !carAlm.includes("SAN JUAN")) return dAlm - 4;
          return null;
        },
        r => {
    ...
    } else if (areaName === "BLEND") {
      extraHeaders = ["F. CARGA", "F. CONTAB. VL", "F. ALM./SELLO", "DÍAS EXP.", "DEMORA EXP.", "DÍAS TRASL.", "DEMORA TRASL."];
      extraFields = [
        r => r["FECHA DE CARGA"],
        r => r["FECHA CONTABILIZACION VL"],
        r => r["FECHA DE ALMACENAMIENTO SELLO"] || r["FECHA ALMACENAMIENTO (LOGIN)"],
        r => r["dEXPEDICION"],
        r => (r["EXCESO EXPEDICION CS"] !== null && r["EXCESO EXPEDICION CS"] !== undefined && r["EXCESO EXPEDICION CS"] !== "") ? r["EXCESO EXPEDICION CS"] : (r["EXPEDICION CS"] || null),
        r => r["dTRASLADO"],
        r => (r["EXCESO TRASLADO CS"] !== null && r["EXCESO TRASLADO CS"] !== undefined && r["EXCESO TRASLADO CS"] !== "") ? r["EXCESO TRASLADO CS"] : (r["TRASLADO CS"] || null)
      ];
      extraColors = [
        {bg: "#e0f2fe", text: "#0369a1", cell: "rgba(224, 242, 254, 0.4)", hex: "FFE0F2FE", cellHex: "FFF0F9FF"}, {bg: "#e0f2fe", text: "#0369a1", cell: "rgba(224, 242, 254, 0.4)", hex: "FFE0F2FE", cellHex: "FFF0F9FF"}, {bg: "#e0f2fe", text: "#0369a1", cell: "rgba(224, 242, 254, 0.4)", hex: "FFE0F2FE", cellHex: "FFF0F9FF"},
        {bg: "#dcfce3", text: "#166534", cell: "rgba(220, 252, 227, 0.4)", hex: "FFDCFCE3", cellHex: "FFF0FDF4"}, {bg: "#dcfce3", text: "#166534", cell: "rgba(220, 252, 227, 0.4)", hex: "FFDCFCE3", cellHex: "FFF0FDF4"},
        {bg: "#ffedd5", text: "#9a3412", cell: "rgba(255, 237, 213, 0.4)", hex: "FFFFEDD5", cellHex: "FFFFF7ED"}, {bg: "#ffedd5", text: "#9a3412", cell: "rgba(255, 237, 213, 0.4)", hex: "FFFFEDD5", cellHex: "FFFFF7ED"}
      ];
    }
  ...
  window.showAreaDetails = function(areaName) {
    ...
    if (areaName.startsWith("COMPRAS")) {
      ...
      explicacionArea = "Un pedido tiene demoras en BLEND cuando el tiempo de Expedición o de Traslado (el viaje a la obra) supera los plazos acordados con el cliente (ej. > 5 días para Olavarría, > 10 días para cliente 38).";
    }
...
${areaName === 'BLEND' ? `<b>Lógica de Cálculo BLEND (Power Query M):</b>

colEXPEDICION = if ([CLASE DE DOC] = "ZPAN" or [CLASE DE DOC] = "ZPAI" or [CLASE DE DOC] = "ZPAS") 
                and [FECHA CONTABILIZACION VL] <> null and [FECHA DE CARGA] <> null 
                then Duration.Days([FECHA CONTABILIZACION VL] - [FECHA DE CARGA]) else null

colEXPEDICION CS = if [dEXPEDICION] <> null and [dEXPEDICION] > 2 then 1 else null

colTRASLADO ALMACEN OBRA = (según CLI):
  ...
  00374 (>11 => -11), 00375 (>3 => -3), 00376 (>2 => -2), 00368 (>2 => -2), 00377 (>2 => -2)

colTRASLADOCS = if [TRASLADO ALMACEN OBRA] = null then null else 1

BLEND = if List.Sum({[TRASLADO CS], [EXPEDICION CS]}) > 0 then 1 else null` 
