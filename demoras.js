...
function filteredRows() {
    ...
    const gcs = getSelValues("clasifSelect");
...
function renderGC() {
    const sel = document.getElementById("clasifSelect");
    if (!sel) return;
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(csvUrl)
        ...
        .then(text => {
            ...
            document.getElementById("clasifSelect")?.addEventListener("change", (e) => { enforceAllOption(e.target); applyAll(); });
